...
const CONTENT: Record<string, { title: string; updated: string; intro: string; sections: { heading: string; body: string }[] }> = {
  en: {
    ...
    sections: [
      ...
      },
      {
        heading: "15. Contact",
        body:
          "For any questions about these Terms, contact us at legal@maadine.ma or write to Marrakech Maadine, Médina, Marrakech, Morocco.",
      },
    ],
  },
  ...
  fr: {
    ...
    sections: [
      ...
      },
      {
        heading: "15. Contact",
        body:
          "Pour toute question relative à ces CGU, contactez-nous à legal@maadine.ma ou écrivez à Marrakech Maadine, Médina, Marrakech, Maroc.",
      },
    ],
  },
  ...
  ar: {
    ...
    intro:
      "تحكم شروط الاستخدام هذه («الشروط») وصولكم إلى منصة مراكش معدن («المنصة») واستخدامكم لها، والتي تُشغّلها مراكش معدن («نحن»). بإنشاء حساب أو تقديم طلب أو نشر منتج، فإنكم توافقون على هذه الشروط بالكامل. في حال عدم الموافقة، يتعيّن عليكم عدم استخدام المنصة.",
    sections: [
      {
        heading: "١. التعريفات",
        body:
          "• **المنصة**: موقع مراكش معدن الإلكتروني وجميع الخدمات المرتبطة به.\n• **المستخدم**: أي شخص يصل إلى المنصة، سواء أكان مسجّلاً أم زائراً.\n• **المشتري**: مستخدم يشتري منتجات عبر المنصة.\n• **البائع**: مستخدم يعرض منتجات ويبيعها عبر المنصة.\n• **المشرف**: موظف في المنصة أو ممثل مفوّض عنها.\n• **الإدراج**: منتج أو خدمة معروض للبيع على المنصة.\n• **الطلب**: معاملة شراء مؤكّدة بين مشترٍ وبائع تيسّرها المنصة.",
      },
      {
      ...
      },
      {
        ...
        body:
          "جميع محتويات المنصة — بما فيها اسم مراكش معدن والشعار والتصميم والبرمجيات والمحتوى التحريري — هي ملك لمراكش معدن ومحمية بموجب قانون الملكية الفكرية المغربي والدولي.\n\nيحتفظ البائعون بملكية المحتوى الذي ينشرونه (صور المنتجات، الأوصاف). بنشر المحتوى، تمنحون مراكش معدن ترخيصاً غير حصري وبلا مقابل لعرض هذا المحتوى وإعادة إنتاجه وترويجه بهدف تشغيل المنصة والتسويق لها.\n\nيُحظر استخراج محتوى المنصة أو نسخه أو إعادة إنتاجه دون إذن كتابي منّا.",
      },
      {
      ...
      },
      {
        heading: "١٥. التواصل",
        body:
          "لأي أسئلة بشأن هذه الشروط، تواصلوا معنا على: legal@maadine.ma أو راسلوا: مراكش معدن، المدينة العتيقة، مراكش، المغرب.",
      },
    ],
  },
};
      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        ...
        <div className="mt-10 text-center">
          <div className="inline-flex items-center gap-2 text-xs text-[#8b8378]">
            ...
            {locale === "ar" ? "هذه الشروط ملزمة قانونياً وتحكم استخدامكم لمنصة مراكش معدن." : locale === "fr" ? "Ces CGU sont juridiquement contraignantes et régissent votre utilisation de Marrakech Maadine." : "These Terms are legally binding and govern your use of the Marrakech Maadine platform."}
          </div>
        </div>
      </div>
    </div>
