    ...
    sections: [
      {
        ...
        body: "The data controller responsible for your personal data is Marrakech Maadine, a marketplace platform registered in Morocco. For any privacy-related enquiries, please contact us at contact@maadinemarrakech.com.",
      },
      {
    ...
    sections: [
      {
        ...
        body: "Le responsable du traitement de vos données personnelles est Marrakech Maadine, une plateforme marketplace enregistrée au Maroc. Pour toute question relative à la confidentialité, contactez-nous à l'adresse contact@maadinemarrakech.com.",
      },
      {
    ...
    sections: [
      {
        ...
        body: "المتحكم في معالجة بياناتكم الشخصية هو مراكش معادن، منصة سوق إلكتروني مسجّلة في المغرب. لأي استفسارات تتعلق بالخصوصية، يُرجى التواصل معنا على: contact@maadinemarrakech.com.",
      },
      {
